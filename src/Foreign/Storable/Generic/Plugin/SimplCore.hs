...
module Foreign.Storable.Generic.Plugin.SimplCore ( core2core, simplifyExpr, simplifyPgm ) where
...
simplifyPgmIO pass@(CoreDoSimplify max_iterations mode)
  ...
  where
    ...
    do_iteration us iteration_no counts_so_far binds rules
      ...
      , () <- sz `seq` ()     -- Force it
      = do {
           putStrLn "Thou has received" ;
           putStrLn $ showSDoc dflags $ ppr $ map getIdsBind binds ;
           ...
           putStrLn "Thou shall simplify tagged binds";
           putStrLn $ showSDoc dflags $ ppr $ map getIdsBind tagged_binds ;
           ...
           putStrLn "Thou ist transformed: " ;
           putStrLn $ showSDoc dflags $ ppr $ map getIdsBind binds1 ;
           ...
           putStrLn "Thou ist shorted out: " ;
           putStrLn $ showSDoc dflags $ ppr $ map getIdsBind binds2 ;
